...
// Defining QRCode here since Vercel serverless loves to play with my sanity and patience (local imports don't work for some reason and I cba to spend time figuring out why)
